...
data_path = './data/DCAIS_[30, 1001, 1002]_region_[37.6, 39, -122.9, -122.2]_01-04_to_30-06_trips.csv'
# data_path = './data/DCAIS_[80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 1017, 1024]_region_[47.5, 49.3, -125.5, -122.5]_01-04_to_30-06_trips.csv'
file_name = os.path.basename(data_path)
file_name = os.path.splitext(file_name)[0]

metric = 'frechat'

folder = f'./results/{file_name}/{metric}/'
