...
# Clustering
measure_nmi = analysis.factor_cluster_analysis(data_path, 'DP', folder, metric=metric)
measure_nmi_tr = analysis.factor_cluster_analysis(data_path, 'TR', folder, metric=metric)
measure_nmi_sp = analysis.factor_cluster_analysis(data_path, 'SP', folder, metric=metric)
measure_nmi_tr_sp = analysis.factor_cluster_analysis(data_path, 'TR_SP', folder, metric=metric)
measure_nmi_sp_tr = analysis.factor_cluster_analysis(data_path, 'SP_TR', folder, metric=metric)
measure_nmi_dp_sp = analysis.factor_cluster_analysis(data_path, 'DP_SP', folder, metric=metric)
measure_nmi_sp_dp = analysis.factor_cluster_analysis(data_path, 'SP_DP', folder, metric=metric)
measure_nmi_tr_dp = analysis.factor_cluster_analysis(data_path, 'TR_DP', folder, metric=metric)
measure_nmi_dp_tr = analysis.factor_cluster_analysis(data_path, 'DP_TR', folder, metric=metric)
